...
let path = {
	...
	app: {
		...
		css: [appFolder + "/css/ion.rangeSlider.css",
		appFolder + "/css/slick.css",
		appFolder + "/css/jquery.fancybox.css",
		appFolder + "/scss/style.scss"],
		js: [appFolder + "/js/ion-rangeslider/ion.rangeSlider.js",
		appFolder + "/js/slick.js",
		appFolder + "/js/fancybox/jquery.fancybox.js",
		appFolder + "/js/main.js"],
